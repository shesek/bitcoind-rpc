...
var url = require('url');
var debug = require('debug')('elementsd')
...
function rpc(request, callback) {
  debug('sending request: %j', request)
  ...
  var req = this.protocol.request(options, function(res) {
    ...
    res.on('end', function() {
      ...
      debug('got status code: %d', res.statusCode)
...
RpcClient.callspec = {
  ...
  backupWallet: '',
  createMultiSig: '',
  createRawTransaction: 'obj obj int obj',
  ...
  sendToAddress: 'str float str str bool str bool',
  setAccount: '',
  ...
  blindRawTransaction: 'str',
  dumpBlindingKey: 'str',
  importBlindingKey: 'str str',
  dumpAssetLabels: '',
